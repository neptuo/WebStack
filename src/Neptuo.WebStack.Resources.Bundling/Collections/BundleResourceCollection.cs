using Neptuo.WebStack.Resources.Bundling.Formatters;
using Neptuo.WebStack.Resources.FileResources;
using System;
...
namespace Neptuo.WebStack.Resources.Bundling.Collections
{
    /// <summary>
