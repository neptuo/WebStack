...
namespace Neptuo.WebStack.Templates.Runtime
{
    ...
    /// </summary>
    internal abstract class ComponentModelBase
    {
        /// <summary>
        /// Target control.
        /// </summary>
        ...
        /// </summary>
        public List<ObserverModelBase> Observers { get; private set; }
        ...
        {
            Observers = new List<ObserverModelBase>();
    ...
    /// <summary>
    /// Typed version of <see cref="ComponentModelBase"/>.
    /// </summary>
    /// <typeparam name="T">Target control type.</typeparam>
    internal class ComponentModel<T> : ComponentModelBase
    {
        private T control;
